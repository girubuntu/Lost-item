...
<head>
    ...
    <main class='container-fluid mb-5'>
        <ul class="nav nav-tabs justify-content-center text-dark mb-5" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" data-toggle="tab" href="#posts">All</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#Animals/Pets">Animals/Pets</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#footer">Electronics</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Tools and Materials</a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content">
            <section id='posts' class="container tab-pane active">
            ...
            <!-- <section id='Animals/Pets' class="container tab-pane active">
            <h4>Hello, world.</h4>
                <div class="container my-4">
                    <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
                        <?php foreach($posts  as $post): ?>
