    ...
    <main class='container'>
        ...
        <form class='row'>
            ...
            <div class='col-sm-12'><h4 class='mb-5 mt-5'>Contact Information</h4></div>
                ...
                <button class='btn submit mt-3 mb-5 pr-5 pl-5 btn-lg text-light'>Publish</button>
            <!-- <div id="shiva"><span class="count">232</span> Happy clients </div>
            <div id="shiva"><span class="count">521</span> Projects </div>
            <div id="shiva"><span class="count">1463</span> Hours of support </div>
            <div id="shiva"><span class="count">15</span> Hardworkers </div> -->
        </form>
    </main>
    <!--footer-->
